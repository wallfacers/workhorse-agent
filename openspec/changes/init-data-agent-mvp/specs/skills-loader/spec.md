...
- **WHEN** `~/.dataagent/skills/` 下有 `git-helper/skill.yaml` 和 `code-review/skill.yaml`
...
- **WHEN** `~/.dataagent/skills/foo/skill.yaml` 与 `~/.dataagent/skills/bar/skill.yaml` 都声明 `name: helper`
